...
DEFAULTS = {
    ...
    "category_settings": {
        "harmony-in-my-head": {
            ...
            # station-ID/show-promo montages (typically at show open and close)
